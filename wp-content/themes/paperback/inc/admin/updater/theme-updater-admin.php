...
class Array_Theme_Updater_Admin {
	...
	function license_page() {
		...
		if( is_multisite() ) {
			$jetpackUrl = network_admin_url( 'plugin-install.php?tab=plugin-information&plugin=jetpack&TB_iframe=true&width=640&height=589' );
		} else {
			$jetpackUrl = admin_url( 'plugin-install.php?tab=plugin-information&plugin=jetpack&TB_iframe=true&width=640&height=589' );
		}
	?>
					...
					<div id="panel" class="panel">
						...
						<div id="plugins-panel" class="panel-left">
							...
							<h4><?php esc_html_e( 'Jetpack', 'paperback' ); ?>
								...
								<?php } else { ?>
									<span class="button button-secondary disabled"><i class="fa fa-check"></i> <?php esc_html_e( 'Installed', 'paperback' ); ?></span>
								<?php } ?>
							</h4>
						...
						<div id="support-panel" class="panel-left">
							...
							<p><a href="http://arraythemes.com/support/forum/<?php echo $theme_name_lower; ?>" title="<?php esc_attr_e( 'View support forum', 'paperback' ); ?>"><?php esc_html_e( 'Support Forum &rarr;', 'paperback' ); ?></a></p>

...
jQuery(document).ready(function(){"use strict";function e(e,t){e=String(e).replace(/[^0-9a-f]/gi,""),e.length<6&&(e=e[0]+e[0]+e[1]+e[1]+e[2]+e[2]),t=t||0;var r,a,o="#";for(a=0;a<3;a++)r=parseInt(e.substr(2*a,2),16),r=Math.round(Math.min(Math.max(0,r+r*t),255)).toString(16),o+=("00"+r).substr(r.length);return o}function t(){jQuery("img").attr("data-no-retina","true"),jQuery("img.retina").removeAttr("data-no-retina","false")}function r(){"1"!==ecko_theme_vars.general_disable_syntax_highlighter&&Rainbow.color()}function a(){jQuery(".overlay-media-embed, .post-contents, .postcontents").fitVids(),jQuery(".fluid-width-video-wrapper").parent("p").addClass("post-contents-video")}function o(){"1"==ecko_theme_vars.general_hidecomments&&""===window.location.hash&&(jQuery(".comments-main").hide(),jQuery(".post-comments-body").prepend('<div class="post-show-comments"><i class="fa fa-comment-o"></i>'+ecko_theme_vars.localization_view_comments+"</div>"))}function s(){var e=jQuery(".cover-blog-posts .cover-post").first();jQuery(e).addClass("cover-post-active"),jQuery(".post-category",e).css("background",jQuery(".post-category",e).attr("data-category-color"))}function i(){jQuery(".cover-post-2").length&&jQuery(".cover-post-background-2").css("background-image","url("+jQuery(".cover-post-2").attr("data-background-image")+")"),jQuery(".cover-post-3").length&&jQuery(".cover-post-background-3").css("background-image","url("+jQuery(".cover-post-3").attr("data-background-image")+")")}function n(){jQuery("nav li.menu-item-has-children > a").each(function(){jQuery(this).html(jQuery(this).text()+'<i class="fa fa-chevron-down"></i>')}),jQuery(".widget.navigation .menu-item-has-children > a").append('<i class="fa fa-caret-down"></i>')}function u(){jQuery(".eckogallery br").remove(),jQuery("article.format-gallery").each(function(e){jQuery(".post-header-gallery",this).height(jQuery(".post-header-gallery .eckogallery a",this).height()),setTimeout(function(){jQuery(".post-list-masonry").length&&Q.masonry("layout")},400)})}function c(e,t){0===jQuery(e).find(".active").length&&jQuery(e).find(".eckogallery > a:first-child").first().addClass("active"),jQuery(e).find(".active").fadeOut(400);var r=jQuery(e).find(".active").next();0===r.length&&(r=jQuery(e).find(".eckogallery > a").first()),jQuery(e).find(".active").removeClass("active"),jQuery(r).addClass("active"),jQuery(r).fadeIn(400),t()}function l(e,t){0===jQuery(e).find(".active").length&&jQuery(e).find(".eckogallery > a:first-child").first().addClass("active"),jQuery(e).find(".active").fadeOut(400);var r=jQuery(e).find(".active").prev();0===r.length&&(r=jQuery(e).find(".eckogallery > a").last()),jQuery(e).find(".active").removeClass("active"),jQuery(r).addClass("active"),jQuery(r).fadeIn(400),t()}function y(){jQuery(".required.email").attr("placeholder",ecko_theme_vars.localization_email_address+"..."),jQuery(".widget.subscribe .inner form").append('<i class="fa fa-envelope-o subscribe-icon"></i><i class="fa fa-arrow-right subscribe-submit"></i>'),jQuery(".footer-subscribe form").append('<i class="fa fa-arrow-right subscribe-submit"></i>')}function d(){"1"==ecko_theme_vars.pagination_enable_ajax&&(jQuery(".pagination-standard").hide(),jQuery(".pagination-ajax").show())}function p(e){if(jQuery(".pagination-older").length>0){var t=jQuery(".pagination-older").attr("href");jQuery.get(t,function(r){var o=jQuery(r).find(".post-list article.post"),s=jQuery(r).find(".pagination-older").attr("href"),i=jQuery(r).find(".pagination-current-page").text();jQuery(o).addClass("post-new"),jQuery(o).css("opacity","0"),jQuery("body").hasClass("page-layout-masonry")?(jQuery(o).css("display","none"),jQuery(".post-list-posts").append(o),jQuery(".post-list").imagesLoaded(function(){jQuery(o).css("display","block"),Q.masonry("appended",o),jQuery(".pagination-current-page").text(i),u()})):(jQuery(".post-list-posts").append(o),jQuery(".post-list article.post").css("opacity","1"),jQuery(".post-list").imagesLoaded(function(){u()})),a(),history.replaceState(null,null,t),jQuery(".pagination-active-page").text(parseInt(jQuery(".pagination-active-page").text())+1),jQuery(".post-list").imagesLoaded(function(){void 0!==s?(jQuery(".pagination-older").attr("href",s),e()):(jQuery(".pagination-older").remove(),jQuery(".pagination-load-more").html('<i class="fa fa-close"></i> '+ecko_theme_vars.localization_no_more_posts),jQuery(".pagination-load-more").unbind())})})}}function j(){u()}if(function(){s(),t(),a(),n(),d(),y(),r(),o()}(),jQuery(window).load(function(){u(),setTimeout(function(){i()},5e3)}),jQuery(".post-list-masonry").length){var Q=jQuery(".post-list-masonry .post-list-posts").masonry({itemSelector:".post, .page",percentPosition:!0});Q.imagesLoaded().progress(function(){Q.masonry("layout")}),Q.imagesLoaded(function(){Q.masonry("layout")}),jQuery(window).load(function(){Q.masonry("layout")})}"1"==ecko_theme_vars.topbar_sticky&&(jQuery(document).scrollTop()>0?jQuery(".top-bar-sticky").addClass("top-bar-stuck"):jQuery(".top-bar-sticky").removeClass("top-bar-stuck"),jQuery(window).scroll(function(){jQuery(document).scrollTop()>0?jQuery(".top-bar-sticky").addClass("top-bar-stuck"):jQuery(".top-bar-sticky").removeClass("top-bar-stuck")})),jQuery(".post-comments-body .post-show-comments").click(function(){jQuery(".post-comments-body .post-show-comments").hide(),jQuery(".comments-main").slideDown(500)}),setInterval(function(){var e=jQuery(".cover-post-active"),t=jQuery(e).next();0===jQuery(t).length&&(t=jQuery(".cover-blog-posts .cover-post").first()),jQuery(e).removeClass("cover-post-active"),jQuery(e).addClass("cover-post-inactive"),jQuery(t).removeClass("cover-post-inactive"),jQuery(t).addClass("cover-post-active"),jQuery(".post-category",e).css("background",""),jQuery(".post-category",t).css("background",jQuery(".post-category",t).attr("data-category-color")),jQuery(".cover-post-background-"+jQuery(e).attr("data-post-id")).css("opacity",0),jQuery(".cover-post-background-"+jQuery(t).attr("data-post-id")).css("opacity",.7)},8e3),jQuery(".show-search").on("click",function(){if(jQuery(window).width()>960)return jQuery(".page-overlay-search").addClass("page-overlay-open"),setTimeout(function(){jQuery(".page-overlay-search .query").focus()},1e3),!1}),jQuery(".widget.navigation li.menu-item-has-children > a").on("click",function(){var e=jQuery(this).parent();return jQuery("a i",e).toggleClass("fa-chevron-down"),jQuery("a i",e).toggleClass("fa-chevron-up"),jQuery(".sub-menu",e).slideToggle(),!1}),jQuery("li.menu-item-has-children > a").on("click",function(){if("#"==jQuery(this).attr("href"))return!1}),jQuery(".show-nav").on("click",function(){jQuery("nav.navigation-responsive > ul, nav.navigation-responsive > div > ul").fadeToggle()}),jQuery("nav.navigation-responsive li.menu-item-has-children > a").on("click",function(){var e=jQuery(this).parent();return jQuery("a i",e).toggleClass("fa-chevron-down"),jQuery("a i",e).toggleClass("fa-chevron-up"),jQuery(".sub-menu",e).slideToggle(),!1}),jQuery(".post-header-gallery .post-gallery-next").live("click",function(){var e=jQuery(this).closest(".post-header-gallery");c(e,function(){jQuery(".post-header-gallery").height(jQuery(".post-header-gallery .eckogallery .active img").height()),jQuery(".post-list-masonry").length&&setTimeout(function(){jQuery(".post-list-masonry").length&&Q.masonry("layout")},400)})}),jQuery(".post-header-gallery .post-gallery-previous").live("click",function(){var e=jQuery(this).closest(".post-header-gallery");l(e,function(){jQuery(".post-header-gallery").height(jQuery(".post-header-gallery .eckogallery .active img").height()),jQuery(".post-list-masonry").length&&setTimeout(function(){jQuery(".post-list-masonry").length&&Q.masonry("layout")},400)})}),jQuery(".page-overlay-close").on("click",function(){jQuery(this).closest(".page-overlay").removeClass("page-overlay-open"),jQuery(".page-overlay-media .overlay-media-embed").html("")}),jQuery(".filter-bar-categories").length&&jQuery(".filter-bar-categories .active a").css("background-color",jQuery(".filter-bar-categories .active a").attr("data-category-color")),jQuery(".filter-bar-options li a").mouseenter(function(){jQuery(this).parent().hasClass("active")?jQuery(this).css("background-color",e(jQuery(this).attr("data-category-color"),-.25)):jQuery(this).css("background-color",jQuery(this).attr("data-category-color"))}).mouseleave(function(){jQuery(this).parent().hasClass("active")?jQuery(this).css("background-color",jQuery(this).attr("data-category-color")):jQuery(this).css("background-color","")}),jQuery(".category-fade").live("mouseenter",function(){jQuery(this).css("background",e(jQuery(this).attr("data-category-color"),-.25))}).live("mouseleave",function(){jQuery(this).css("background",jQuery(this).attr("data-category-color"))}),jQuery(".post-related-post .post-category").css("background",""),jQuery(".post-related-post").mouseenter(function(){var e=jQuery(".post-category",this);jQuery(e).css("background",jQuery(e).attr("data-category-color"))}).mouseleave(function(){jQuery(".post-category",this).css("background","")}),jQuery(".post-play, .post.format-video .post-header-image").live("click",function(e){if(jQuery(window).width()>960&&jQuery(window).height()>915){var t=jQuery(this).closest(".post"),r=jQuery(t).attr("data-post-id"),a=jQuery("<div/>").html(window.post_video[r]).text();return jQuery(".page-overlay-media .overlay-media-embed").html(a),jQuery(".page-overlay-media .post-title a").text(jQuery(".post-title",t).text()),jQuery(".page-overlay-media .post-excerpt").text(jQuery(".post-excerpt",t).text()),jQuery(".page-overlay-media .post-title a").attr("href",jQuery(".post-title a",t).attr("href")),jQuery(".page-overlay-media .post-read-more").attr("href",jQuery(".post-title a",t).attr("href")),jQuery(".page-overlay-media").addClass("page-overlay-open"),jQuery(".overlay-media-embed").fitVids(),!1}}),jQuery(".back-to-top").on("click",function(){return jQuery("html, body").animate({scrollTop:"0px"},800),!1}),jQuery(".post-list-standard .post .post-title a").mouseenter(function(){jQuery(this).closest(".post-info").find(".post-date-category").addClass("active")}).mouseleave(function(){jQuery(this).closest(".post-info").find(".post-date-category").removeClass("active")}),jQuery(".scroll-cover").on("click",function(){return jQuery("html, body").animate({scrollTop:jQuery(".cover").height()},800),!1}),jQuery(".subscribe-submit, .search-submit, .widget_search .submit").on("click",function(){jQuery(this).parent("form").submit()}),jQuery(".pagination-load-more").on("click",function(){var e=this;return jQuery(this).html('<i class="fa fa-spinner"></i> '+ecko_theme_vars.localization_fetching_posts),p(function(){jQuery(e).text(ecko_theme_vars.localization_load_more)}),!1}),jQuery(".eckogallery, .gallery").each(function(){jQuery(this).magnificPopup({delegate:"a",type:"image",mainClass:"mfp-no-margins mfp-with-zoom",gallery:{enabled:!0},image:{verticalFit:!0},zoom:{enabled:!0,duration:300}})}),jQuery(".post-contents .eckogallery").justifiedGallery({rowHeight:160,maxRowHeight:220,margins:3,border:0,lastRow:"justify",captions:!1,cssAnimation:!0,imagesAnimationDuration:300});var g;jQuery(window).resize(function(){clearTimeout(g),g=setTimeout(j,100)})});
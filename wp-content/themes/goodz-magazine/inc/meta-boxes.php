...
/*                                                          */
/************************************************************/
require( get_template_directory().'/inc/meta-box-config.php' );

foreach ( $meta_boxes as $meta_box ) {
    $my_box = new Goodz_magazine_meta_box($meta_box);
}

class Goodz_magazine_meta_box {
    ...
    function show() {
        ...
        foreach ($this->_meta_box['fields'] as $field) {
            ...
            switch ($field['type']) {
                ...
                /************************************************************/
                case 'repeatable':
                    echo '<small>' . __( 'Drag to reorder images', 'goodz-magazine' ) . '</small>';
                    ...
                    echo '<a class="repeatable-add button" href="#">+</a> <span class="add-repeatable">' . __( 'Click to add another meta box', 'goodz-magazine' ) . '</span>';
                    break;
